...
public class Game {
    ...
    public static class Builder {
        ...
        public Game build() throws SymbolDuplicacyException, PlayersCountDimensionMismatchException, MoreThanOneBotException {
            validate();
            return new Game(boardSize, players, winningStrategies);
        }

        private void validate() throws MoreThanOneBotException, PlayersCountDimensionMismatchException, SymbolDuplicacyException {
            validateBotCount();
